...
grep -q '^CorrectPauseMapAspect=1$' "$FIXTURE/mgs4_native_centered_hud.ini"
grep -q '^CorrectCodecRealtimeAspect=1$' "$FIXTURE/mgs4_native_centered_hud.ini"
grep -q '^CorrectMissionBriefingAspect=1$' "$FIXTURE/mgs4_native_centered_hud.ini"
