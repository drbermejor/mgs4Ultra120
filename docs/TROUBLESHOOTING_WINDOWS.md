...
Download alpha.6 or newer. Some valid official `launcher_sv` variants omit
...
Alpha.6 and newer accept either complete window-size pair, update all available
...
Redownload alpha.6 or newer: discovery treats an offline
